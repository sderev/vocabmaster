...
def isolated_app_dir(tmp_path, monkeypatch):
    """Redirect the app data directory to an isolated tmp path."""
...
def test_anki_requires_default_pair(isolated_app_dir):
...
def test_config_default_requires_existing_pairs(isolated_app_dir):
...
def test_tokens_requires_default_pair(isolated_app_dir):
...
def test_show_handles_absent_pairs(isolated_app_dir):
